	...
	if response_code == 200:
		...
		if parse_result == OK:
			...
			if json_response.has("candidates") and json_response["candidates"].size() > 0:
				...
				var dialogue_path = "res://dialogues/conversations/base_guide_translated.dialogue"
				ensure_dialogue_directory()
...
func use_fallback_dialogue() -> void:
	...
	var dialogue_path = "res://dialogues/conversations/base_guide.dialogue"
	ensure_dialogue_directory()
...
func trigger_dialogue_on_start() -> void:
	...
	var dialogue_path = "res://dialogues/conversations/base_guide"

...
func _on_http_request_request_completed(result: int, response_code: int, headers: PackedStringArray, body: PackedByteArray) -> void:
	if response_code == 200:
		...
		if error == OK:
			...
			if FileAccess.file_exists("res://dialogues/coversations/legislative.dialogue"):
				DirAccess.remove_absolute("res://dialogues/coversations/legislative.dialogue")
			...
			# Write new file
			var file = FileAccess.open("res://dialogues/coversations/legislative.dialogue", FileAccess.WRITE)
...
func trigger_dialogue_on_start() -> void:
	...
	balloon.start(load("res://dialogues/coversations/legislative.dialogue"), "start")
